...
// const CALLBACK_URL = `${process.env.BASE_URL}/api/auth/google/callback`;
...
//     if (!state || !['teacher', 'student'].includes(state)) {
...
//     const redirectPath = user.userData.role === 'teacher' ? '/wizard' : '/dashboard';
